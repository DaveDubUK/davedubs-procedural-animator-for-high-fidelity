...
controlsBackground = Overlays.addOverlay("image", {
					...
					imageURL: "http://localhost/downloads/hf/overlays/ddao-background.png",
					color: { red: 255, green: 255, blue: 255},
					alpha: 1
				});
controlsBackgroundWalkEdit = Overlays.addOverlay("image", {
					bounds: { x: backgroundX, y: backgroundY, width: 0, height: 0},
					imageURL: "http://localhost/downloads/hf/overlays/ddao-background-walk-edit.png",
					color: { red: 255, green: 255, blue: 255},
					alpha: 1
				});
controlsBackgroundStandEdit = Overlays.addOverlay("image", {
					bounds: { x: backgroundX, y: backgroundY, width: 0, height: 0},
					imageURL: "http://localhost/downloads/hf/overlays/ddao-background-stand-edit.png",
					color: { red: 255, green: 255, blue: 255},
					alpha: 1
				});
controlsBackgroundFlyingEdit = Overlays.addOverlay("image", {
					bounds: { x: backgroundX, y: backgroundY, width: 0, height: 0},
					imageURL: "http://localhost/downloads/hf/overlays/ddao-background-flying-edit.png",
					color: { red: 255, green: 255, blue: 255},
					alpha: 1
				});
controlsMinimisedTab = Overlays.addOverlay("image", {
					bounds: { x: Window.innerWidth - 35, y: Window.innerHeight/2 - 175, width: 0, height: 0},
					imageURL: "http://localhost/downloads/hf/overlays/ddao-tab.png",
					color: { red: 255, green: 255, blue: 255},
					alpha: 1
				});
...
walkSpeedSlider = Overlays.addOverlay("image", {
					...
					imageURL: "http://localhost/downloads/hf/overlays/ddao-slider-handle.png",
					color: { red: 255, green: 255, blue: 255},
					alpha: 1
				});
